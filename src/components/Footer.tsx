    ...
    <footer className="bg-page-text text-page-bg py-16 sm:py-24">
      <div className="max-w-7xl mx-auto px-6 lg:px-8 grid grid-cols-1 md:grid-cols-4 gap-12 sm:gap-8">
        ...
        <div className="md:col-span-1">
          ...
          <p className="text-page-bg/70 font-montserrat text-sm leading-relaxed mb-6">
        ...
        <div>
          ...
          <ul className="flex flex-col gap-4 text-page-bg/70 font-montserrat text-sm">
            <li><Link href="/" className="hover:text-white transition-colors">Inicio</Link></li>
            <li><Link href="/nosotros" className="hover:text-white transition-colors">Nosotros</Link></li>
            <li><Link href="/proyectos/sunset-condominios" className="hover:text-white transition-colors">Proyectos</Link></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="flex flex-col gap-4 text-page-bg/70 font-montserrat text-sm">
            <li className="flex items-center gap-3">
              ...
              <a href="mailto:hola@sunsetbaja.com" className="hover:text-white transition-colors">hola@sunsetbaja.com</a>
            </li>
            <li className="flex items-center gap-3">
            ...
            <li className="flex items-start gap-3">
              ...
              <span>Malecón de La Paz, B.C.S., México</span>
            </li>
          </ul>
        </div>
        ...
        <div>
          ...
          <div className="flex items-center gap-4">
            <a href="#" className="w-10 h-10 rounded-full bg-page-bg/5 border border-page-bg/10 flex items-center justify-center text-page-bg/70 hover:bg-page-bg/15 hover:text-white transition-all hover:-translate-y-1">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 mt-16 pt-8 border-t border-page-bg/10 flex flex-col sm:flex-row items-center justify-between gap-4">
        <p className="text-page-bg/50 font-montserrat text-xs">
          © {new Date().getFullYear()} Sunset Desarrolladora. Todos los derechos reservados.
        </p>
        <div className="flex items-center gap-4 text-page-bg/50 font-montserrat text-xs">
